...
[zr_interp, zr_dot_interp] = generate_random_profile(t14, Vx0(j),RC);
n_RK5=length(t14)-1;
counter=0;
Per=0;
for i=1:(n_RK5)
    ...
    kx1=vehicle_suspension(t14(i),y14(i,:),Vx0(j), zrfl, zrfr, zrrl, zrrr, zrfl_dot, zrfr_dot, zrrl_dot, zrrr_dot);
    kx2=vehicle_suspension(t14(i)+0.25*h,y14(i,:)+(1/4)*h*kx1,Vx0(j), zrfl, zrfr, zrrl, zrrr, zrfl_dot, zrfr_dot, zrrl_dot, zrrr_dot);
    kx3=vehicle_suspension(t14(i)+0.25*h,y14(i,:)+((1/8)*kx1+(1/8)*kx2)*h,Vx0(j), zrfl, zrfr, zrrl, zrrr, zrfl_dot, zrfr_dot, zrrl_dot, zrrr_dot);
    kx4=vehicle_suspension(t14(i)+0.5*h,y14(i,:)+(-0.5*kx2+kx3)*h,Vx0(j), zrfl, zrfr, zrrl, zrrr, zrfl_dot, zrfr_dot, zrrl_dot, zrrr_dot);
    kx5=vehicle_suspension(t14(i)+(3/4)*h,y14(i,:)+((3/16)*kx1+(9/16)*kx4)*h,Vx0(j), zrfl, zrfr, zrrl, zrrr, zrfl_dot, zrfr_dot, zrrl_dot, zrrr_dot);
    kx6=vehicle_suspension(t14(i)+h,y14(i,:)+((-3/7)*kx1+(2/7)*kx2+(12/7)*kx3-(12/7)*kx4+(8/7)*kx5)*h,Vx0(j), zrfl, zrfr, zrrl, zrrr, zrfl_dot, zrfr_dot, zrrl_dot, zrrr_dot);
...
zufr(i),zurl(i),zurr(i),Z(i),zrfl, zrfr, zrrl, zrrr, zrfl_dot, zrfr_dot, zrrl_dot, zrrr_dot,Vx0(j));
end
