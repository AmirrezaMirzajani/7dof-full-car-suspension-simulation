...
for j = 1:n_Ks
        counter_Ks=counter_Ks+1;
    n_Ks_100=n_Ks/100;

   if counter_Ks==n_Ks_100
        Per_Ks=Per_Ks+1
        counter_Ks=0;
    end
    ...
    if counter==n_RK5_100
        ...
        kx1 = vehicle_suspension_Ks(t14(i), y14(i,:), Ks(j),Cs(j),zrfl, zrfr, zrrl, zrrr, zrfl_dot, zrfr_dot, zrrl_dot, zrrr_dot,Vx);
        kx2 = vehicle_suspension_Ks(t14(i) + 0.25 * h, y14(i,:) + (1/4) * h * kx1, Ks(j),Cs(j),zrfl, zrfr, zrrl, zrrr, zrfl_dot, zrfr_dot, zrrl_dot, zrrr_dot,Vx);
        kx3 = vehicle_suspension_Ks(t14(i) + 0.25 * h, y14(i,:) + ((1/8) * kx1 + (1/8) * kx2) * h, Ks(j),Cs(j),zrfl, zrfr, zrrl, zrrr, zrfl_dot, zrfr_dot, zrrl_dot, zrrr_dot,Vx);
        kx4 = vehicle_suspension_Ks(t14(i) + 0.5 * h, y14(i,:) + (-0.5 * kx2 + kx3) * h, Ks(j),Cs(j),zrfl, zrfr, zrrl, zrrr, zrfl_dot, zrfr_dot, zrrl_dot, zrrr_dot,Vx);
        kx5 = vehicle_suspension_Ks(t14(i) + (3/4) * h, y14(i,:) + ((3/16) * kx1 + (9/16) * kx4) * h, Ks(j),Cs(j),zrfl, zrfr, zrrl, zrrr, zrfl_dot, zrfr_dot, zrrl_dot, zrrr_dot,Vx);
        kx6 = vehicle_suspension_Ks(t14(i) + h, y14(i,:) + ((-3/7) * kx1 + (2/7) * kx2 + (12/7) * kx3 - (12/7) * kx4 + (8/7) * kx5) * h, Ks(j),Cs(j),zrfl, zrfr, zrrl, zrrr, zrfl_dot, zrfr_dot, zrrl_dot, zrrr_dot,Vx);
...
ztfl_dot(j) = zufl_dot(j) - zrfl_dot + E;
ztfr_dot(j) = zufr_dot(j) - zrfr_dot + E;
ztrl_dot(j) = zurl_dot(j) - zrrl_dot + E;
ztrr_dot(j) = zurr_dot(j) - zrrr_dot + E;

ztfl(j) = zufl(j) - zrfl + E;
ztfr(j) = zufr(j) - zrfr + E;
ztrl(j) = zurl(j) - zrrl + E;
ztrr(j) = zurr(j) - zrrr + E;
...
surf(K(21:end-20,21:end-20), T(21:end-20,21:end-20), Fsfl_matrix(21:end-20,21:end-20)); % Plot 3D surface
...
meshz(K(21:end-20,21:end-20), T(21:end-20,21:end-20), Fsfl_matrix(21:end-20,21:end-20)); % Plot 3D surface
xlabel('Stiffness (Ks)', 'FontSize', 12, 'FontName', 'Arial', 'Interpreter', 'latex');
ylabel('Time(s)', 'FontSize', 12, 'FontName', 'Arial', 'Interpreter', 'latex');
zlabel('Suspension Force (Fsfl)', 'FontSize', 12, 'FontName', 'Arial', 'Interpreter', 'latex');
title('3D Surface Plot of Suspension Force vs. Time and Stiffness', 'FontSize', 14, 'FontName', 'Arial', 'Interpreter', 'latex');
...
contourf(K(21:end-20,21:end-20), T(21:end-20,21:end-20), Fsfl_matrix(21:end-20,21:end-20)); % Plot 2D contour
xlabel('Stiffness (Ks)', 'FontSize', 12, 'FontName', 'Arial', 'Interpreter', 'latex');
ylabel('Time(s)', 'FontSize', 12, 'FontName', 'Arial', 'Interpreter', 'latex');
...
surf(K(21:end-20,21:end-20), T(21:end-20,21:end-20), Fsfr_matrix(21:end-20,21:end-20)); % Plot 3D surface
xlabel('Stiffness (Ks)', 'FontSize', 12, 'FontName', 'Arial', 'Interpreter', 'latex');
ylabel('Time(s)', 'FontSize', 12, 'FontName', 'Arial', 'Interpreter', 'latex');
...
% Second subplot (3D Mesh Plot)
subplot(2, 2, 2); % 2 rows, 2 columns, 2nd plot
meshz(K(21:end-20,21:end-20), T(21:end-20,21:end-20), Fsfr_matrix(21:end-20,21:end-20)); % Plot 3D surface
xlabel('Stiffness (Ks)', 'FontSize', 12, 'FontName', 'Arial', 'Interpreter', 'latex');
ylabel('Time(s)', 'FontSize', 12, 'FontName', 'Arial', 'Interpreter', 'latex');
zlabel('Suspension Force (Fsfr)', 'FontSize', 12, 'FontName', 'Arial', 'Interpreter', 'latex');
title('3D Surface Plot of Suspension Force vs. Time and Stiffness', 'FontSize', 14, 'FontName', 'Arial', 'Interpreter', 'latex');
...
% Third subplot (2D Contour Plot)
subplot(2, 2, 3); % 2 rows, 2 columns, 3rd plot
contourf(K(21:end-20,21:end-20), T(21:end-20,21:end-20), Fsfr_matrix(21:end-20,21:end-20)); % Plot 2D contour
xlabel('Stiffness (Ks)', 'FontSize', 12, 'FontName', 'Arial', 'Interpreter', 'latex');
ylabel('Time(s)', 'FontSize', 12, 'FontName', 'Arial', 'Interpreter', 'latex');
title('2D Contour Plot of Suspension Force vs. Time and Stiffness', 'FontSize', 14, 'FontName', 'Arial', 'Interpreter', 'latex');
colorbar;
...
surf(K(21:end-20,21:end-20), T(21:end-20,21:end-20), Fsrl_matrix(21:end-20,21:end-20)); % Plot 3D surface
xlabel('Stiffness (Ks)', 'FontSize', 12, 'FontName', 'Arial', 'Interpreter', 'latex');
ylabel('Time(s)', 'FontSize', 12, 'FontName', 'Arial', 'Interpreter', 'latex');
...
% Second subplot (3D Mesh Plot)
subplot(2, 2, 2); % 2 rows, 2 columns, 2nd plot
meshz(K(21:end-20,21:end-20), T(21:end-20,21:end-20), Fsrl_matrix(21:end-20,21:end-20)); % Plot 3D surface
xlabel('Stiffness (Ks)', 'FontSize', 12, 'FontName', 'Arial', 'Interpreter', 'latex');
ylabel('Time(s)', 'FontSize', 12, 'FontName', 'Arial', 'Interpreter', 'latex');
zlabel('Suspension Force (Fsrl)', 'FontSize', 12, 'FontName', 'Arial', 'Interpreter', 'latex');
title('3D Surface Plot of Suspension Force vs. Time and Stiffness', 'FontSize', 14, 'FontName', 'Arial', 'Interpreter', 'latex');
...
% Third subplot (2D Contour Plot)
subplot(2, 2, 3); % 2 rows, 2 columns, 3rd plot
contourf(K(21:end-20,21:end-20), T(21:end-20,21:end-20), Fsrl_matrix(21:end-20,21:end-20)); % Plot 2D contour
xlabel('Stiffness (Ks)', 'FontSize', 12, 'FontName', 'Arial', 'Interpreter', 'latex');
ylabel('Time(s)', 'FontSize', 12, 'FontName', 'Arial', 'Interpreter', 'latex');
title('2D Contour Plot of Suspension Force vs. Time and Stiffness', 'FontSize', 14, 'FontName', 'Arial', 'Interpreter', 'latex');
colorbar;
...
surf(K(21:end-20,21:end-20), T(21:end-20,21:end-20), Fsrr_matrix(21:end-20,21:end-20)); % Plot 3D surface
xlabel('Stiffness (Ks)', 'FontSize', 12, 'FontName', 'Arial', 'Interpreter', 'latex');
ylabel('Time(s)', 'FontSize', 12, 'FontName', 'Arial', 'Interpreter', 'latex');
...
% Second subplot (3D Mesh Plot)
subplot(2, 2, 2); % 2 rows, 2 columns, 2nd plot
meshz(K(21:end-20,21:end-20), T(21:end-20,21:end-20), Fsrr_matrix(21:end-20,21:end-20)); % Plot 3D surface
xlabel('Stiffness (Ks)', 'FontSize', 12, 'FontName', 'Arial', 'Interpreter', 'latex');
ylabel('Time(s)', 'FontSize', 12, 'FontName', 'Arial', 'Interpreter', 'latex');
zlabel('Suspension Force (Fsrr)', 'FontSize', 12, 'FontName', 'Arial', 'Interpreter', 'latex');
title('3D Surface Plot of Suspension Force vs. Time and Stiffness', 'FontSize', 14, 'FontName', 'Arial', 'Interpreter', 'latex');
...
% Third subplot (2D Contour Plot)
subplot(2, 2, 3); % 2 rows, 2 columns, 3rd plot
contourf(K(21:end-20,21:end-20), T(21:end-20,21:end-20), Fsrr_matrix(21:end-20,21:end-20)); % Plot 2D contour
xlabel('Stiffness (Ks)', 'FontSize', 12, 'FontName', 'Arial', 'Interpreter', 'latex');
ylabel('Time(s)', 'FontSize', 12, 'FontName', 'Arial', 'Interpreter', 'latex');
title('2D Contour Plot of Suspension Force vs. Time and Stiffness', 'FontSize', 14, 'FontName', 'Arial', 'Interpreter', 'latex');
colorbar;
