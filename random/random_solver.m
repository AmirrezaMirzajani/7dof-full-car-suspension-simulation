...
for i = 1:n_RK5
    ...
    kx1 = vehicle_suspension_old(t14(i), y14(i,:), Vx, zrfl, zrfr, zrrl, zrrr, zrfl_dot, zrfr_dot, zrrl_dot, zrrr_dot);
    kx2 = vehicle_suspension_old(t14(i) + 0.25*h, y14(i,:) + (1/4)*h*kx1, Vx, zrfl, zrfr, zrrl, zrrr, zrfl_dot, zrfr_dot, zrrl_dot, zrrr_dot);
    kx3 = vehicle_suspension_old(t14(i) + 0.25*h, y14(i,:) + ((1/8)*kx1 + (1/8)*kx2)*h, Vx, zrfl, zrfr, zrrl, zrrr, zrfl_dot, zrfr_dot, zrrl_dot, zrrr_dot);
    kx4 = vehicle_suspension_old(t14(i) + 0.5*h, y14(i,:) + (-0.5*kx2 + kx3)*h, Vx, zrfl, zrfr, zrrl, zrrr, zrfl_dot, zrfr_dot, zrrl_dot, zrrr_dot);
    kx5 = vehicle_suspension_old(t14(i) + (3/4)*h, y14(i,:) + ((3/16)*kx1 + (9/16)*kx4)*h, Vx, zrfl, zrfr, zrrl, zrrr, zrfl_dot, zrfr_dot, zrrl_dot, zrrr_dot);
    kx6 = vehicle_suspension_old(t14(i) + h, y14(i,:) + ((-3/7)*kx1 + (2/7)*kx2 + (12/7)*kx3 - (12/7)*kx4 + (8/7)*kx5)*h, Vx, zrfl, zrfr, zrrl, zrrr, zrfl_dot, zrfr_dot, zrrl_dot, zrrr_dot);
...
ylabel('$\2dot{z}_{usfl}$', 'Interpreter', 'latex', 'FontName', 'Arial', 'FontSize', 15);
...
ylabel('$\2dot{z}_{usfr}$', 'Interpreter', 'latex', 'FontName', 'Arial', 'FontSize', 15);
xlabel('Time (s)', 'Interpreter', 'latex', 'FontName', 'Arial', 'FontSize', 12);
grid on;
...
ylabel('$\2dot{z}_{usrl}$', 'Interpreter', 'latex', 'FontName', 'Arial', 'FontSize', 15);
xlabel('Time (s)', 'Interpreter', 'latex', 'FontName', 'Arial', 'FontSize', 12);
grid on;
...
ylabel('$\dot{z}_{usrr}$', 'Interpreter', 'latex', 'FontName', 'Arial', 'FontSize', 15);
xlabel('Time (s)', 'Interpreter', 'latex', 'FontName', 'Arial', 'FontSize', 12);
grid on;
