function out=suspension_Zeta(t14,phi_dot,theta_dot,Z_dot,zufl_dot,zufr_dot,zurl_dot,zurr_dot,phi,theta,zufl,zufr,zurl,zurr,Z,zeta,zrfl, zrfr, zrrl, zrrr, zrfl_dot, zrfr_dot, zrrl_dot, zrrr_dot)
%% 
Vx=30;
Vy=0;
%% parameters
